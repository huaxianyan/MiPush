...
object PushSignWatcher : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    fun watch() {
        ...
        val pushSignPref = ProcessContext.require().createDeviceProtectedStorageContext()
    ...
    private fun notifyChange() {
        ProcessContext.require().contentResolver.notifyChange(BridgeUri.PUSH_SIGN.toUri(), null, false)
